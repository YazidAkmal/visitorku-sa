...
<template>
  <div class="flex flex-col h-full min-h-[calc(100vh-150px)] bg-[#F8FAFC]">
    <div class="px-6 md:px-8 py-6 flex-1">
    ...
    <div
      class="sticky bottom-0 mt-auto bg-white border-t border-gray-100 px-6 md:px-8 py-4 flex gap-4 z-30"
    >
      <button
        @click="emit('close')"
        class="flex-1 py-3 rounded-xl border border-[#2BB5F4] text-[#2BB5F4] font-semibold text-[13px] hover:bg-[#EAF8FF] transition-colors focus:outline-none"
      >
