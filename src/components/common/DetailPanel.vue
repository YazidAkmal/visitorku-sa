  ...
  <Teleport to="body">
    ...
    >
      <div
        v-if="isOpen"
        @click="$emit('close')"
        class="fixed inset-0 bg-black/40 z-9990 backdrop-blur-sm"
      ></div>
    </Transition>
    ...
    >
      ...
      >
        <div class="relative shrink-0 bg-[#2BB5F4]">
          ...
          <button
            @click="$emit('close')"
            class="absolute top-6 right-6 text-white/90 hover:text-white transition-colors focus:outline-none z-30"
          >
            <svg
