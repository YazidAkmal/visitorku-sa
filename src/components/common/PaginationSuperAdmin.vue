...
<template>
  <div
    class="flex flex-col md:flex-row items-center justify-between gap-4 mt-6 pt-4 border-t border-gray-100"
  >
    <div class="text-[13px] text-gray-500 font-medium text-center md:text-left">
      {{ $t('common_layout.pagination', { showingCount: showingCount, totalData: totalData }) }}
    </div>
