...
<template>
  <div v-if="isLoadingDetail" class="flex flex-col items-center justify-center py-20 h-full min-h-[calc(100vh-200px)] bg-[#F8FAFC]">
  ...
  <div v-else class="bg-[#F8FAFC] h-full min-h-[calc(100vh-200px)]">
    ...
    <div class="px-6 md:px-8 mb-4 flex gap-4 items-center">
      ...
      <button @click="changeTab('Jumlah Visitor')" class="px-4 py-1.5 rounded-full text-[12px] font-medium border transition-colors focus:outline-none" :class="activeTab === 'Jumlah Visitor' ? 'border-[#2BB5F4] text-[#2BB5F4] bg-[#2BB5F4]/5' : 'border-gray-200 text-gray-500 hover:bg-gray-50'">Jumlah Visitor</button>
      <button @click="changeTab('Latest Visitor')" class="px-4 py-1.5 rounded-full text-[12px] font-medium border transition-colors focus:outline-none" :class="activeTab === 'Latest Visitor' ? 'border-[#2BB5F4] text-[#2BB5F4] bg-[#2BB5F4]/5' : 'border-gray-200 text-gray-500 hover:bg-gray-50'">Latest Visitor</button>
    </div>
    ...
    <div class="px-6 md:px-8 pb-10">
      ...
      <div v-if="activeTab === 'Latest Visitor'">
        ...
        <div v-else class="w-full py-10 flex flex-col items-center justify-center text-gray-400 bg-white border border-gray-100 rounded-lg ">
