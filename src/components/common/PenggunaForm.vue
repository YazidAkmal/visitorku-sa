...
<template>
  <div class="px-6 md:px-8 py-6 pb-10 bg-[#F8FAFC] h-full min-h-[calc(100vh-150px)] flex flex-col">
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-6 ">
      ...
      <div class="space-y-4">
        <div>
          <label class="block text-[13px] text-gray-800 font-medium mb-1.5">Nama Lengkap <span class="text-red-500">*</span></label>
        ...
        <div>
          <label class="block text-[13px] text-gray-800 font-medium mb-1.5">Alamat Email <span class="text-red-500">*</span></label>
