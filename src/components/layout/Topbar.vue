  ...
  >
    ...
    <div class="relative z-10 flex items-center gap-5">
      <button
        ...
        class="w-8.5 h-8.5 bg-light-blue rounded-full flex items-center justify-center hover:bg-white transition-all shadow-sm relative group"
      >
        <img
          :src="globeIcon"
          alt="Language"
        ...
        >
          ...
          >
            ...
            >
              ...
              {{ $t('common_layout.action') === 'Action' ? 'Logout' : 'Keluar' }}
            </button>
          </div>
        </Transition>
      </div>
