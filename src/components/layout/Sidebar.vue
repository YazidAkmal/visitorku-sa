...
const mainMenuItems = computed(() => [
  {
    ...
    path: '/dashboard',
    icon: dashboardIcon,
    iconSelected: selectedDashboardIcon,
  },
  {
    name: t('sidebar.company_List'),
    path: '/daftar-perusahaan',
    icon: daftarperusahaanIcon,
    iconSelected: selectedDaftarPerusahaanIcon,
  },
  {
    name: t('sidebar.invoice'),
    path: '/riwayat-tagihan',
    icon: riwayattagihanIcon,
    iconSelected: selectedRiwayatTagihanIcon,
  },
